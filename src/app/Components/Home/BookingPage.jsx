...
import { addSession } from "../../redux/cartRedux/cartSlice";
...
const BookingPage = () => {
  ...
  console.log(token,"hiiiiii")
  console.log(token[0].name,"weee")
  ...
  return (
    <div className="max-w-5xl mx-auto p-10">
      ...
      <h2 className="text-lg font-semibold text-grey-600">Welcome {token[0].name}</h2>
